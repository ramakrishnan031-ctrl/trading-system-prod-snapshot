...
P2 = durability + safety (schema v36 `gtt_state`, reconcile, GTT_EXIT, 15-min monitor); delivery_enabled stays **false** (no activation). **DEPLOYED to main `bad0aad` 25-Jun ~22:23 (one-time authorized; rule restored); schema v36 applies at the Fri 08:15 boot.** **FIX-183 (26-Jun) adds orphan-GTT adoption** (no schema; branch `fix-183-gtt-adoption-26jun`, NOT yet deployed). Detail: SYSTEM_MAP Changelog 2026-06-25/26 · memory `slice25_p2_gtt_durability_25jun` · `fix_183_gtt_adoption_26jun`.

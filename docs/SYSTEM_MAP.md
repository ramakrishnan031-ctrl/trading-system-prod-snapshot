...
# Last updated: 2026-06-24 by Claude Code (Opus) — Slice 2: 3-layer strategy control (trade_type + per-strategy enabled) + resolver-driven status table; default all-15-enabled (zero-change) · Part C: all 15 strategies R:R 1.5 · governor lost-alert + briefing debounce · after-check circuit-clamp-aware · tgt_retry crash-loop post-mortem
